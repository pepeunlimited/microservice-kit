...
type JWT interface {
	...
	SignIn(exp time.Duration, username string, email *string, role *string, userId *int64) (string, error)
...
func (kit microkitjwt) SignIn(exp time.Duration, username string, email *string, role *string, userId *int64) (string, error) {
