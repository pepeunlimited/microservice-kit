...
const (
	...
	AccessTokenExpiration		= "ACCESS_TOKEN_EXPIRATION_KEY"
	RefreshTokenExpiration		= "REFRESH_TOKEN_EXPIRATION_KEY"
	NewRefreshTokenExpiration	= "NEW_REFRESH_TOKEN_EXPIRATION_KEY"
)
